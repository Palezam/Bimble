...
public class RecyclerTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public RecyclerTileEntity(BlockPos pos, BlockState state) {
		super(BimbleModBlockEntities.RECYCLER.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<RecyclerTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<RecyclerTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
