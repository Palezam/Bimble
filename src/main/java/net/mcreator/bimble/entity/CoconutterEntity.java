...
public class CoconutterEntity extends Monster implements GeoEntity {
	...
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(CoconutterEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(CoconutterEntity.class, EntityDataSerializers.STRING);
	...
	public CoconutterEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(BimbleModEntities.COCONUTTER.get(), world);
	}

	public CoconutterEntity(EntityType<CoconutterEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "coconutter_texture");
	}
	...
	private PlayState movementPredicate(AnimationState event) {
		if (this.animationprocedure.equals("empty")) {
			if ((event.isMoving() || !(event.getLimbSwingAmount() > -0.15F && event.getLimbSwingAmount() < 0.15F))
				...
				return event.setAndContinue(RawAnimation.begin().thenLoop("coconutter_run"));
			}
			return event.setAndContinue(RawAnimation.begin().thenLoop("coconutter_idle"));
		}
	...
	private PlayState attackingPredicate(AnimationState event) {
		...
		if (this.swinging && event.getController().getAnimationState() == AnimationController.State.STOPPED) {
			...
			return event.setAndContinue(RawAnimation.begin().thenPlay("coconutter_jab"));
		}
